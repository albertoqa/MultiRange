...
//        registerChangeListener(multiRange.valueProperty(), "VALUE");
//        registerChangeListener(multiRange.orientationProperty(), "ORIENTATION");
//        registerChangeListener(multiRange.showTickMarksProperty(), "SHOW_TICK_MARKS");
//        registerChangeListener(multiRange.showTickLabelsProperty(), "SHOW_TICK_LABELS");
//        registerChangeListener(multiRange.majorTickUnitProperty(), "MAJOR_TICK_UNIT");
//        registerChangeListener(multiRange.minorTickCountProperty(), "MINOR_TICK_COUNT");
//        registerChangeListener(multiRange.labelFormatterProperty(), "TICK_LABEL_FORMATTER");
//        registerChangeListener(multiRange.snapToTicksProperty(), "SNAP_TO_TICKS");
    }
    ...
    StringConverter<Number> stringConverterWrapper = new StringConverter<Number>() {
        ...
        public String toString(Number object) {
            return (object != null) ? MultiRange.getLabelFormatter().toString(object.doubleValue()) : "";
        }

        @Override
        public Number fromString(String string) {
            return MultiRange.getLabelFormatter().fromString(string);
        }
    };
    ...
    private void setShowTickMarks(boolean ticksVisible, boolean labelsVisible) {
        ...
        if (showTickMarks) {
            if (tickLine == null) {
                ...
                tickLine.setSide(MultiRange.getOrientation() == Orientation.VERTICAL ? Side.RIGHT : (MultiRange.getOrientation() == null) ? Side.RIGHT : Side.BOTTOM);
                ...
                // add 1 to the MultiRange minor tick count since the axis draws one
                // less minor ticks than the number given.
                tickLine.setMinorTickCount(Math.max(MultiRange.getMinorTickCount(), 0) + 1);
                if (MultiRange.getLabelFormatter() != null) {
...
//            tickLine = null;
    ...
    protected void handleControlPropertyChanged(String p) {
        ...
        if ("ORIENTATION".equals(p)) {
            ...
            setShowTickMarks(MultiRange.isShowTickMarks(), MultiRange.isShowTickLabels());
    ...
    protected void layoutChildren(final double x, final double y,
        ...
        if (getSkinnable().getOrientation() == Orientation.HORIZONTAL) {
            ...
            double startY = y + ((h - totalHeightNeeded) / 2); // center MultiRange in available height vertically
            ...
            double startX = x + ((w - totalWidthNeeded) / 2); // center MultiRange in available width horizontally
    ...
    protected double computeMinWidth(double height, double topInset, double rightInset, double bottomInset, double leftInset) {
        final MultiRange s = getSkinnable();
